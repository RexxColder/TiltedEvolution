...
#elif TP_FALLOUT4
    // FO4 equivalent: WinMain (address is the game's main WinMain entry).
    // Find in Address Library: search for the WinMain entry point
    // (exported symbol "WinMain" in Fallout4.exe).
    POINTER_FALLOUT4(void, winMain, 0); // Corrected WinMain ID
#endif
...
#elif TP_FALLOUT4
    POINTER_FALLOUT4(uint32_t, bAlwaysActive, 0); // TODO: Add correct Fallout 4 offset
#endif
