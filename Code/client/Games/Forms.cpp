...
#if TP_FALLOUT4
    POINTER_FALLOUT4(TGetFormById, getFormById, 13410);
#else
...
#if TP_FALLOUT4
    POINTER_FALLOUT4(InternalGetChangeFlags, internalGetChangeFlags, 0); // TODO
    POINTER_FALLOUT4(Unk*, s_singleton, 0);                              // TODO
#else
...
#if TP_FALLOUT4
    // TODO(FO4): Implement GetChangeFlags logic if needed, or stub for now
    (void)pUnk;
    (void)internalGetChangeFlags;
    const auto cResult = false;
#else
