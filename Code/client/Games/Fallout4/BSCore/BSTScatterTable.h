...
// 00
template <class Key> struct BSTScatterTableDefaultHashPolicy
{
...
template <class Key, class Value, template <class, class> class Storage = BSTScatterTableDefaultKVStorage> struct BSTScatterTableEntry : public Storage<Key, Value>
{
private:
...
// 00
template <class Entry> struct BSTScatterTableHeapAllocator
{
...
// 00
template <class Key, class Value, template <class, class> class Storage, class HashPolicy, class Allocator, size_t INITIAL_TABLE_SIZE> struct BSTScatterTableTraits
{
...
class BSTScatterTableKernel : public Traits,                // 00
...
public:
    ...
    public:
        ...
        hash_type operator()(const key_type& key) const { return hash_policy::get_hash(key); }
    };
    ...
    public:
        ...
        bool operator()(const key_type& a, const key_type& b) const { return hash_policy::is_key_equal(a, b); }
    };
    ...
    size_type size() const { return m_size - m_freeCount; }

    size_type free_count() const { return m_freeCount; }
...
protected:
    ...
    inline entry_type* _entry_at(entry_type* entries, hash_type hash) const { return entries + (hash & (m_size - 1)); }
    ...
    static inline void _entry_move(entry_type* to, entry_type* from) { memcpy_s(to, sizeof(*to), from, sizeof(*from)); }
...
template <class Traits> uint32_t BSTScatterTableKernel<Traits>::sentinel = 0x0EFBEADDE; // DEADBEEF

// 1>class BSTScatterTableBase<struct BSTScatterTableTraits<struct StringCache::Ref, class NiPointer<class BGSAttackData>, struct BSTScatterTableDefaultKVStorage, struct BSTScatterTableDefaultHashPolicy<struct StringCache::Ref>, struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<struct
// StringCache::Ref, class NiPointer<class BGSAttackData>, struct BSTScatterTableDefaultKVStorage> >, 8> >	size(28) : 1>	+-- - 1> 0 | +-- - (base class BSTScatterTableKernel<struct BSTScatterTableTraits<struct StringCache::Ref, class NiPointer<class BGSAttackData>, struct
// BSTScatterTableDefaultKVStorage, struct BSTScatterTableDefaultHashPolicy<struct StringCache::Ref>, struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<struct StringCache::Ref, class NiPointer<class BGSAttackData>, struct BSTScatterTableDefaultKVStorage> >, 8> >)
// 1> 0	| | +-- - (base class BSTScatterTableTraits<struct StringCache::Ref, class NiPointer<class BGSAttackData>, struct BSTScatterTableDefaultKVStorage, struct BSTScatterTableDefaultHashPolicy<struct StringCache::Ref>, struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<struct
// StringCache::Ref, class NiPointer<class BGSAttackData>, struct BSTScatterTableDefaultKVStorage> >, 8>) 1>	| | +-- - 1> 1	| | +-- - (base class BSTScatterTableDefaultHashPolicy<struct StringCache::Ref>) 1>	| | +-- - 1>  	| | <alignment member> (size = 3) 1> 4	| | m_size 1> 8	| |
// m_freeCount 1>0C	| | m_freeOffset 1>10	| | m_eolPtr 1> | +-- - 1>19 | +-- - (base class BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<struct StringCache::Ref, class NiPointer<class BGSAttackData>, struct BSTScatterTableDefaultKVStorage> >) 1> | +-- - 1> | <alignment member> (size
// = 7) 1>20 | m_entries 1>	+-- -

template <class Traits>
class BSTScatterTableBase : public BSTScatterTableKernel<Traits>, // 00
...
public:
    ...
    public:
        ...
        operator pointer() const { return static_cast<pointer>(m_entry); }
        reference operator*() const { return *(pointer) * this; }
        ...
        bool operator==(const _iter& rhs) const { return (m_entry == rhs.m_entry); }
        bool operator!=(const _iter& rhs) const { return (!(*this == rhs)); }
    ...
    public:
        ...
        operator pointer() { return static_cast<pointer>(m_entry); }
        reference operator*() { return *(pointer) * this; }
        pointer operator->() { return (pointer) * this; }
    };

    iterator begin() { return iterator(this, _entry_head()); }
    const_iterator begin() const { return const_iterator(this, _entry_head()); }
    const_iterator cbegin() const { return const_iterator(this, _entry_head()); }

    iterator end() { return iterator(this, _entry_head() + m_size); }
    const_iterator end() const { return const_iterator(this, _entry_head() + m_size); }
    const_iterator cend() const { return const_iterator(this, _entry_head() + m_size); }

    hasher hash_function() const { return hasher(); }

    key_equal key_eq() const { return key_equal(); }

    inline void clear() { this->_clear(m_entries); }
...
protected:
    ...
    inline entry_type* _entry_head() const { return const_cast<entry_type*>(m_entries); }
    inline entry_type* _entry_last() const { return _entry_head() + (max_size() - 1); }
    inline entry_type* _entry_tail() const { return _entry_head() + max_size(); }

    inline entry_type* _get_free_entry() { return BSTScatterTableKernel<Traits>::_get_free_entry(m_entries); }
...
// 1>	+-- -
// 1> 0 | +-- - (base class BSTScatterTableBase<struct BSTScatterTableTraits<struct StringCache::Ref, class NiPointer<class BGSAttackData>, struct BSTScatterTableDefaultKVStorage, struct BSTScatterTableDefaultHashPolicy<struct StringCache::Ref>, struct BSTScatterTableHeapAllocator<struct
// BSTScatterTableEntry<struct StringCache::Ref, class NiPointer<class BGSAttackData>, struct BSTScatterTableDefaultKVStorage> >, 8> >) 1> 0	| | +-- - (base class BSTScatterTableKernel<struct BSTScatterTableTraits<struct StringCache::Ref, class NiPointer<class BGSAttackData>, struct
// BSTScatterTableDefaultKVStorage, struct BSTScatterTableDefaultHashPolicy<struct StringCache::Ref>, struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<struct StringCache::Ref, class NiPointer<class BGSAttackData>, struct BSTScatterTableDefaultKVStorage> >, 8> >) 1> 0	| | | +-- -
// (base class BSTScatterTableTraits<struct StringCache::Ref, class NiPointer<class BGSAttackData>, struct BSTScatterTableDefaultKVStorage, struct BSTScatterTableDefaultHashPolicy<struct StringCache::Ref>, struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<struct StringCache::Ref, class
// NiPointer<class BGSAttackData>, struct BSTScatterTableDefaultKVStorage> >, 8>) 1>	| | | +-- - 1> 1	| | | +-- - (base class BSTScatterTableDefaultHashPolicy<struct StringCache::Ref>) 1>	| | | +-- - 1>  	| | | <alignment member> (size = 3) 1> 4	| | | m_size
// 1> 8	| | | m_freeCount
// 1>0C	| | | m_freeOffset
// 1>10	| | | m_eolPtr
// 1>	| | +-- -
...
// 1> | +-- -
// 1>	+-- -
template <class Key, class Value, template <class, class> class Storage, template <class> class Policy, template <class> class Allocator, size_t INITIAL_TABLE_SIZE>
...
public:
    ...
    BSTScatterTable(const BSTScatterTable& rhs)
        : Base()
    {
        _assign(rhs);
    }
    ...
    size_type count(const key_type& key) const { return _find(m_entries, get_hash(key), key) ? 1 : 0; }
    ...
    inline size_type erase(const key_type& key) { return _erase(m_entries, get_hash(key), key) ? 1 : 0; }
    ...
    inline bool SetAt(key_type key, const value_type& lvalue) { return insert(key, lvalue); }

    inline bool SetAt(key_type key, value_type&& rvalue) { return insert(key, rvalue); }

    inline bool RemoveAt(key_type key) { return erase(key) != 0; }
...
// BSTScatterTableDefaultKVStorage, struct BSTScatterTableDefaultHashPolicy<struct StringCache::Ref>, struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<struct StringCache::Ref, class NiPointer<class BGSAttackData>, struct BSTScatterTableDefaultKVStorage> >, 8> >)
// 1> 0	| | | | +-- - (base class BSTScatterTableTraits<struct StringCache::Ref, class NiPointer<class BGSAttackData>, struct BSTScatterTableDefaultKVStorage, struct BSTScatterTableDefaultHashPolicy<struct StringCache::Ref>, struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<struct
// StringCache::Ref, class NiPointer<class BGSAttackData>, struct BSTScatterTableDefaultKVStorage> >, 8>) 1>	| | | | +-- - 1> 1	| | | | +-- - (base class BSTScatterTableDefaultHashPolicy<struct StringCache::Ref>) 1>	| | | | +-- - 1>  	| | | | <alignment member> (size = 3)
// 1> 4	| | | | m_size
// 1> 8	| | | | m_freeCount
// 1>0C	| | | | m_freeOffset
// 1>10	| | | | m_eolPtr
...
// 1>	+-- -
// 1>
template <class Key, class Value> struct BSTDefaultScatterTable : public BSTScatterTable<Key, Value, BSTScatterTableDefaultKVStorage, BSTScatterTableDefaultHashPolicy, BSTScatterTableHeapAllocator, 8>
{
};
