...
struct TES
{
    ...
    void* activeImageSpaceModifiers;
};
...
struct ProcessLists
{
    ...
    void* highActorHandleArray;
    void* lowActorHandleArray;
    void* middleHighActorHandleArray;
    void* middleLowActorHandleArray;
    void* actorBuckets[4];
};

static_assert(offsetof(ProcessLists, highActorHandleArray) == 0x30);
// static_assert(offsetof(ProcessLists, actorBuckets) == 0x90); // FO4 different
...
// static_assert(offsetof(ModManager, mods) == 0xD60); // FO4 different
