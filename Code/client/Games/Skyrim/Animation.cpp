...
// Compatibility layer for ActorState flags between Skyrim and Fallout 4
#if TP_FALLOUT4
#define ACTOR_STATE_FLAGS1 actorState.flags04
#define ACTOR_STATE_FLAGS2 actorState.flags08
#else
#define ACTOR_STATE_FLAGS1 actorState.flags1
#define ACTOR_STATE_FLAGS2 actorState.flags2
#endif
...
uint8_t TP_MAKE_THISCALL(HookPerformAction, ActorMediator, TESActionData* apAction)
{
    ...
    {
        ActionEvent action;
        action.State1 = pActor->ACTOR_STATE_FLAGS1;
        action.State2 = pActor->ACTOR_STATE_FLAGS2;
